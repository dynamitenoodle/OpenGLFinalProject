...
{
    {
		...
		oneMesh->InitWithVertexArray(oneVertices, _countof(oneVertices), shaderProgram);
		...
		/*Creating the number objects*/
		{
			// 1
			myNumberEntities[numberCount] = new GameEntity(
				oneMesh,
				material,
				glm::vec3(-1.0f, 3.0f, 0.0f),
				glm::vec3(0, 0, 0),
				glm::vec3(0.05f, 0.2f, 1.0f),
				window,
				false
			);
			myNumberEntities[numberCount]->NewColor(1.0f, 1.0f, 1.0f, 1.f);
			numberCount++;
